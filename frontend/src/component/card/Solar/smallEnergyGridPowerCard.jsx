...
const SmallEnergyGridPowerCard = ({ Data }) => {
    ...
    const energyValue = (Data && Array.isArray(Data) && Data.length) ? Math.abs(Data[Data.length - 1].total_grid_energy_kwh - Data[0].total_grid_energy_kwh) : 0;
    ...
    return (
        <Card sx={{ ...styles.thinBorder, width: '300px', height: '250px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 5, borderRadius: '20px', bgcolor: tempCheck.bgColor, borderColor: tempCheck.borderColor, borderWidth: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'left', color: tempCheck.colors }}>
                ...
                <Typography variant='h6' fontWeight='bold' sx={{ marginLeft: '5px', whiteSpace: 'nowrap',
                    overflow: 'hidden',
...
export default SmallEnergyGridPowerCard;
